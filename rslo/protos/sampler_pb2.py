...
# source: rslo/protos/sampler.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='rslo/protos/sampler.proto',
  ...
  ,
  dependencies=[rslo_dot_protos_dot_preprocess__pb2.DESCRIPTOR,])
...
_SAMPLER.fields_by_name['database_prep_steps'].message_type = rslo_dot_protos_dot_preprocess__pb2._DATABASEPREPROCESSINGSTEP
...
Group = _reflection.GeneratedProtocolMessageType('Group', (_message.Message,), {
  ...
  'NameToMaxNumEntry' : _reflection.GeneratedProtocolMessageType('NameToMaxNumEntry', (_message.Message,), {
    ...
    '__module__' : 'rslo.protos.sampler_pb2'

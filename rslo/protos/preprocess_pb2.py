...
# source: rslo/protos/preprocess.proto
...
DatabasePreprocessingStep = _reflection.GeneratedProtocolMessageType('DatabasePreprocessingStep', (_message.Message,), {
  ...
  '__module__' : 'rslo.protos.preprocess_pb2'

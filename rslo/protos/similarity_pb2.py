...
# source: rslo/protos/similarity.proto
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), {
  ...
  '__module__' : 'rslo.protos.similarity_pb2'

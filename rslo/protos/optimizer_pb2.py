...
# source: rslo/protos/optimizer.proto
...
_LEARNINGRATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exponential_decay_warmup', full_name='second.protos.LearningRate.exponential_decay_warmup', index=4,
...
_ONECYCLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lr_maxs', full_name='second.protos.OneCycle.lr_maxs', index=4,
...
_EXPONENTIALDECAYWARMUP = _descriptor.Descriptor(
  name='ExponentialDecayWarmup',
  full_name='second.protos.ExponentialDecayWarmup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='second.protos.ExponentialDecayWarmup.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decay_length', full_name='second.protos.ExponentialDecayWarmup.decay_length', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decay_factor', full_name='second.protos.ExponentialDecayWarmup.decay_factor', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='staircase', full_name='second.protos.ExponentialDecayWarmup.staircase', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='div_factor', full_name='second.protos.ExponentialDecayWarmup.div_factor', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pct_start', full_name='second.protos.ExponentialDecayWarmup.pct_start', index=5,
...
_LEARNINGRATE.fields_by_name['exponential_decay_warmup'].message_type = _EXPONENTIALDECAYWARMUP
...
_LEARNINGRATE.oneofs_by_name['learning_rate'].fields.append(
  _LEARNINGRATE.fields_by_name['exponential_decay_warmup'])
_LEARNINGRATE.fields_by_name['exponential_decay_warmup'].containing_oneof = _LEARNINGRATE.oneofs_by_name['learning_rate']
...
DESCRIPTOR.message_types_by_name['ExponentialDecayWarmup'] = _EXPONENTIALDECAYWARMUP
...
Optimizer = _reflection.GeneratedProtocolMessageType('Optimizer', (_message.Message,), {
  ...
  '__module__' : 'rslo.protos.optimizer_pb2'
...
ExponentialDecayWarmup = _reflection.GeneratedProtocolMessageType('ExponentialDecayWarmup', (_message.Message,), {
  'DESCRIPTOR' : _EXPONENTIALDECAYWARMUP,
  '__module__' : 'rslo.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:second.protos.ExponentialDecayWarmup)
  })
_sym_db.RegisterMessage(ExponentialDecayWarmup)
